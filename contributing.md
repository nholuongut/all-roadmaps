...
* There is not an infinite opportunity to contribute to the nholuongut/all-roadmaps project.
...
- Submit a roadmap by providing [a textual roadmap similar to this roadmap](https://gist.github.com/nholuongut/98758d2c73799b3a6ce17385e4c548a5) in an [issue](https://github.com/nholuongut/developer-roadmap/issues).
- Create an interactive roadmap yourself using [our roadmap editor](https://github.com/nholuongut) & submit the link to that roadmap in an [issue](https://github.com/nholuongut/developer-roadmap/issues).

## Existing Roadmaps

For the existing roadmaps, please follow the details listed for the nature of contribution:

- **Fixing Typos** — Make your changes in the [roadmap JSON file](https://github.com/nholuongut/developer-roadmap/tree/master/src/data/roadmaps) and submit a [PR](https://github.com/nholuongut/developer-roadmap/pulls).
- **Adding or Removing Nodes** — Please open an [issue](https://github.com/nholuongut/developer-roadmap/issues) with your suggestion.
...
Have a look at this project to get an idea of [what we are looking for](https://github.com/nholuongut/projects/github-user-activity).

## Adding Content

Find [the content directory inside the relevant roadmap](https://github.com/nholuongut/developer-roadmap/tree/master/src/data/roadmaps). Please keep the following guidelines in mind when submitting content:
