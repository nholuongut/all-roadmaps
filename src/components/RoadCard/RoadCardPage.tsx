      ...
      <div className="mx-0 flex items-start gap-4 border-b px-0 py-4 sm:-mx-10 sm:px-10">
        ...
        <div className="flex-grow">
          ...
          <div className="mt-3 flex flex-col gap-3">
            <Editor
              title={'HTML'}
              text={`<a href="https://github.com/nholuongut"><img src="${badgeUrl}" alt="nholuongut/all-roadmaps"/></a>`.trim()}
              onCopy={() => markRoadCardDone()}
            />

            <Editor
              title={'Markdown'}
              text={`[![nholuongut/all-roadmaps](${badgeUrl})](https://github.com/nholuongut)`.trim()}
              onCopy={() => markRoadCardDone()}
            />
          </div>
