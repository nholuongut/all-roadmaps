            ...
            {currentUsername &&
              (currentUsername === username || !username || !isUnique) && (
                <span className="text-xs">
                  Current URL{' '}
                  <a
                    href={`${import.meta.env.DEV ? 'http://localhost:3000' : 'https://github.com/nholuongut'}/u/${currentUsername}`}
                    target="_blank"
                    className={
                  ...
                  >
                    nholuongut/all-roadmaps/u/{currentUsername}
                  </a>
                </span>
              )}
            {currentUsername !== username && username && isUnique && (
              <span className="text-xs text-green-600">
                ...
                >
                  nholuongut/all-roadmaps/u/{username}
                </span>
              </span>
            )}
          </span>
