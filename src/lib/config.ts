export const siteConfig = {
  ...
  url: {
    ...
    repo: 'https://github.com/nholuongut/developer-roadmap',
    contribute:
      'https://github.com/nholuongut/developer-roadmap/tree/master/contributing.md',
    issue: 'https://github.com/nholuongut/developer-roadmap/issues/new',
  },
  keywords: [
    'roadmap',
    'developer roadmaps',
