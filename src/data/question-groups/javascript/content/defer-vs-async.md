...
To know more you can check [this diagram](https://github.com/nholuongut/guides/avoid-render-blocking-javascript-with-async-defer) from us that explains the difference between `defer` and `async` in a visual way.
