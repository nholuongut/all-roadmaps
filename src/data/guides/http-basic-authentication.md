...
authorId: 'kamran'
seo:
  title: 'HTTP Basic Authentication - nholuongut/all-roadmaps'
  description: 'Learn what is HTTP Basic Authentication and how to implement it in Node.js'
isNew: false
type: 'textual'
date: 2022-10-03
...
I have prepared the sample project in Node.js, which can be found on GitHub [nholuongut/node-basic-auth-example](https://github.com/nholuongut/node-basic-auth-example). If you look at the codebase of the project, we have two files `index.js` with the following content:
