...
seo:
  ...
  ogImageUrl: 'https://assets.nholuongut/all-roadmaps/guest/backend-development-tools-ou6el.jpg'
isNew: false
type: 'textual'
date: 2024-03-19
sitemap:
...
![Must-have backend developer tools to use.](https://assets.nholuongut/all-roadmaps/guest/backend-development-tools-ou6el.jpg)
...
![Jetbrains code editor](https://assets.nholuongut/all-roadmaps/guest/jetbrains-code-editor-z7z1t.png)
...
![VSCode code editor](https://assets.nholuongut/all-roadmaps/guest/vscode-code-editor-8pznw.png)
...
![Zed code editor](https://assets.nholuongut/all-roadmaps/guest/zed-code-editor-7ovxz.png)
...
![Sublime code editor](https://assets.nholuongut/all-roadmaps/guest/sublime-text-code-editor-ngtnf.png)
...
![Vim code editor](https://assets.nholuongut/all-roadmaps/guest/vim-code-editor-ohiyc.png)
...
![DataGrip database explorer](https://assets.nholuongut/all-roadmaps/guest/datagrip-database-explorer-l8987.png)
...
![Navicat database explorer](https://assets.nholuongut/all-roadmaps/guest/navicat-database-explorer-r1unn.png)
...
![TablePlus database manager](https://assets.nholuongut/all-roadmaps/guest/tableplus-database-manager-06d09.png)
...
![DBeaver database manager](https://assets.nholuongut/all-roadmaps/guest/dbeaver-database-manager-fvlrd.png)
...
![Trello board](https://assets.nholuongut/all-roadmaps/guest/trello-board-o0i4i.png)
...
![Monday project management tool](https://assets.nholuongut/all-roadmaps/guest/monday-project-management-tool-xws17.png)
...
![Basecamp project management tool](https://assets.nholuongut/all-roadmaps/guest/basecamp-project-management-tool-2pusd.png)
...
![Wrike project management tool](https://assets.nholuongut/all-roadmaps/guest/wrike-project-management-tool-5g3kl.png)
...
![Railway hosting](https://assets.nholuongut/all-roadmaps/guest/railway-hosting-j8me8.png)
...
![Heroku hosting](https://assets.nholuongut/all-roadmaps/guest/heroku-hosting-2u6bz.png)
...
![Digital Ocean hosting](https://assets.nholuongut/all-roadmaps/guest/digital-ocean-hosting-i7a9c.png)
...
![Hetzner hosting](https://assets.nholuongut/all-roadmaps/guest/hetzner-hosting-oupq8.jpg)
...
![Vercel hosting](https://assets.nholuongut/all-roadmaps/guest/vercel-hosting-9jvk9.png)
...
![Render hosting](https://assets.nholuongut/all-roadmaps/guest/render-hosting-w4urq.png)
...
![OVHCloud hosting](https://assets.nholuongut/all-roadmaps/guest/ovhcloud-hosting-ncfch.png)
...
![Swagger API tool](https://assets.nholuongut/all-roadmaps/guest/swagger-api-tool-vngxu.png)
...
![Postman documentation tool](https://assets.nholuongut/all-roadmaps/guest/postman-documentation-tool-cl81q.png)
...
![iTerm terminal developer tool](https://assets.nholuongut/all-roadmaps/guest/iterm-terminal-developer-tool-zze25.png)
...
![Oh my Zsh shell](https://assets.nholuongut/all-roadmaps/guest/zsh-shell-ui-6s163.png)
...
![Raycast app launcher](https://assets.nholuongut/all-roadmaps/guest/raycast-app-launcher-w5rg3.png)
