...
seo:
  ...
  ogImageUrl: 'https://assets.nholuongut/all-roadmaps/guest/backend-languages-2x930.jpg'
isNew: false
type: 'textual'
date: 2024-01-18
sitemap:
...
![The best backend languages to learn.](https://assets.nholuongut/all-roadmaps/guest/backend-languages-2x930.jpg)

Web development is typically divided into two main categories: [backend development](https://github.com/nholuongut/backend) and [frontend development](https://github.com/nholuongut/frontend). Frontend development focuses on the visible part of the application for end-users, i.e. the part that users interact with, while backend development involves writing code that remains unseen but is essential for the functioning of all applications—the business logic.
...
A handy tool when trying to evaluate a language like that is [nholuongut/all-roadmaps](https://github.com/nholuongut).

[![Roadmap.sh](/guides/backend-languages/backend-roadmap-part.png)](https://github.com/nholuongut/backend)

<p align="center" style="font-size: 14px; margin-top: -10px; text-align: center">Small section of the full backend roadmap available on <a href="https://github.com/nholuongut/backend">nholuongut/all-roadmaps</a></p>

There you’ll find community-maintained roadmaps for many career paths within software development. In particular, for this article, the [backend roadmap](https://github.com/nholuongut/backend) is a great place to start, because while picking a backend language is important, you’ll see there that it’s not just about the language. In fact, there is a lot of tech around the language that is also required (I’m referring to databases, git, understanding how client-server communication works, and a big “etc).
...
Lucky for you, if you’re reading this, that means you’ve found the most complete and comprehensive roadmap online: [nholuongut/all-roadmaps](https://github.com/nholuongut), the current [backend roadmap](https://github.com/nholuongut/backend) is filled with details of everything you should and could (optionally) learn in your journey to becoming a backend developer.
...
Remember that there is a very detailed version of a [backend roadmap here](https://github.com/nholuongut/backend), it might be a great place to get started! And if you’re also interested in frontend development, there is an [equally handy roadmap](https://github.com/nholuongut/frontend) here as well!
