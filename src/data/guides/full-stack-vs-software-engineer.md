...
seo:
  title: 'Full Stack Developer or Software Engineer – Which Way to Go?'
  description: 'Unsure about your dev career path? Compare full stack developer and software engineer roles to make an informed decision.'
  ogImageUrl: 'https://assets.nholuongut/all-roadmaps/guest/full-stack-developer-vs-software-engineer-ol28u.png'
isNew: false
type: 'textual'
date: 2024-05-02
sitemap:
...
![Choosing between full stack developer or software engineer.](https://assets.nholuongut/all-roadmaps/guest/full-stack-developer-vs-software-engineer-ol28u.png)
...
![Full stack developer vs Software engineer](https://assets.nholuongut/all-roadmaps/guest/full-stack-vs-software-engineer-e3ozc.jpg)
...
A [full stack developer](https://github.com/nholuongut/full-stack) also known as a full stack programmer possesses the knowledge and technical skill sets to work proficiently in a software application's front-end and back-end.
...
The common programming languages used in front-end development by a full stack developer include HTML, Cascading Style Sheets (CSS), and JavaScript. HTML defines the markup of the web page. CSS builds upon HTML and represents the style and format of the webpage. JavaScript is a programming language often used for front-end development and adds logic to your web page. You’ll find an excellent guide and roadmap to learning [JavaScript](https://github.com/nholuongut/javascript) on our platform.

There are quite a few front-end web development frameworks out there used by full stack developers. Some of the common ones are [React](https://github.com/nholuongut/react), [Vue](https://github.com/nholuongut/vue), and [Angular](https://github.com/nholuongut/angular). You can look at the [front-end beginners roadmap](https://github.com/nholuongut/frontend?r=frontend-beginner) or the [advanced front-end roadmap](https://github.com/nholuongut/frontend?r=frontend) for a more detailed guide.
...
Back end development mainly involves creating API endpoints consumed by the application's front-end. Backend developers usually work with languages such as Python , Java , or Ruby , along with frameworks like Node.js , Django , or Ruby on Rails. Check out the [back-end developer](https://github.com/nholuongut/backend) roadmap.

### Full stack developers' skills

The necessary technical skills to be a full stack developer include:

- Knowledge of HTML, CSS, and [JavaScript](https://github.com/nholuongut/javascript)/[TypeScript](https://github.com/nholuongut/typescript).
- Knowledge of at least one JavaScript framework e.g. [React](https://github.com/nholuongut/react), [Vue js](https://github.com/nholuongut/vue), [Angular](https://github.com/nholuongut/angular).
...
- Basic knowledge of [DevOps](https://github.com/nholuongut/devops).
- Project management skills.

![Full stack developer skills](https://assets.nholuongut/all-roadmaps/guest/fullstack-developer-skills-gbnoy.jpg)
...
System software engineers can also integrate different software products into a single platform; for example, [DevOps](https://github.com/nholuongut/devops) engineers can use tools like [Docker](https://github.com/nholuongut/docker) and [Kubernetes](https://github.com/nholuongut/kubernetes) to deploy and orchestrate applications.
...
- They design the whole system, typically employing the principles of [system design](https://github.com/nholuongut/system-design) and [software design architecture](https://github.com/nholuongut/software-design-architecture). They decide on the software architecture to use for the application by weighing the pros and cons of different system architectures that might be suitable. Some standard architectures are monolith architecture, micro-services architecture, event-driven architecture, etc.

- After deciding on the system architecture, the next step is defining the tools. The tools include programming languages, database management, version control, and cloud systems (Google Cloud, Microsoft Azure, or [Amazon AWS](https://github.com/nholuongut/aws)). Several factors affect the choice of the tools: existing knowledge and expertise, cost, suitability of the tools to the application, and so on.
...
- Knowledge of [computer science fundamentals](https://github.com/nholuongut/computer-science), software development, and [system design](https://github.com/nholuongut/system-design).
...
![Software engineer skills](https://assets.nholuongut/all-roadmaps/guest/software-engineer-skills.jpg)
...
![Full stack developer vs Software engineer salaries](https://assets.nholuongut/all-roadmaps/guest/full-stack-salaries-04wtl.jpg)

## How do I become a full stack developer or software engineer?

As you’ve seen, becoming a full stack developer requires various skill sets. nholuongut/all-roadmaps provides a step-by-step guide on how to become a [full-stack programmer or developer](https://github.com/nholuongut/full-stack), and by signing up, you will be able to:

- Keep track of your learning progress and share it on your public nholuongut/all-roadmaps profile.
- Draw your roadmap, either as an individual learner or for [Dev](https://github.com/nholuongut/teams) [t](https://github.com/nholuongut/teams)[eams](https://github.com/nholuongut/teams).
- [Generate new roadmaps with AI](https://github.com/nholuongut/ai).
- Collaborate on official roadmaps.
 
Recall that a software engineer, as defined above, specializes in different areas in the software development cycle and possesses a thorough knowledge of coding languages and engineering principles. nholuongut/all-roadmaps provides learning paths for various software engineering specializations. You can also sign up for [computer science](https://github.com/nholuongut/computer-science), [data structures and algorithms,](https://github.com/nholuongut/datastructures-and-algorithms) [software design and architecture](https://github.com/nholuongut/software-design-architecture), and [system design](https://github.com/nholuongut/system-design) roadmaps.
