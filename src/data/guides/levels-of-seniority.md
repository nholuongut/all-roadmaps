...
authorId: 'kamran'
seo:
  title: 'Levels of Seniority - nholuongut/all-roadmaps'
  description: 'How to Step Up as a Junior, Mid Level or a Senior Developer?'
isNew: false
type: 'textual'
date: 2020-12-03
...
I have been working on redoing the [roadmaps](https://github.com/nholuongut) – splitting the skillset based on the seniority levels to make them easier to follow and not scare the new developers away. Since the roadmaps are going to be just about the technical knowledge, I thought it would be a good idea to reiterate and have an article on what I think of different seniority roles.
