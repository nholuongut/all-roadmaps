...
- Fetch the recent activity of the specified GitHub user using the GitHub API. You can use the following endpoint to fetch the user's activity:
  ...
  # Example: https://api.github.com/users/nholuongut/events
  ```
- Display the fetched activity in the terminal.
  ```
  Output:
  - Pushed 3 commits to nholuongut/developer-roadmap
  - Opened a new issue in nholuongut/developer-roadmap
  - Starred nholuongut/developer-roadmap
  - ...
  ```
