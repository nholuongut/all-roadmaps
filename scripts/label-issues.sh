...
issues=$(gh issue list --repo nholuongut/developer-roadmap --search "sort:created-asc" --state open --limit 500 --json number,title,createdAt,updatedAt,state,url,comments,reactionGroups,body | jq -c '.[]')
...
while IFS= read -r issue; do
    ...
    # URL is like https://github.com/nholuongut/frontend
